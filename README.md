...
![Lines](https://img.shields.io/badge/Lines-1243-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-hermes-overlay.git

# Oeffnen
cd dkz-hermes-overlay
